...
const explodeOptions = [
    ...
    createDropdownInput("damageType", "Damage Type", BlockConstants.DropDownOptions.DamageType),
...
const jalapenoLaneFireOptions = [
    ...
    createDropdownInput("color", "Color", BlockConstants.DropDownOptions.JalapenoFireColor),
    createDropdownInput("spreadStyle", "Spread Pattern", BlockConstants.DropDownOptions.JalapenoSpreadPattern),
