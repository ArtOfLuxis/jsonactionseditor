class FieldMultilineText extends Blockly.FieldTextInput {
    ...
    onEditorCreated(textarea) {}

    showEditor_() {
        const textarea = document.createElement("textarea")
        textarea.className = "jsonEditor"

        textarea.value = this.getEditorValue(this.getValue())

        this.onEditorCreated(textarea)
        ...
        textarea.addEventListener("change", () => {
            this.setValue(this.getStoredValue(textarea.value))
